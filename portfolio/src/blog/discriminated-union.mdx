...
<Quote
  source=" Discriminated Unions IBM"
...
Same for button, after type narrowing, _Typescript_ will know that `onClick` is inside the props object.
...
- [Discriminated unions in official Typescript documentation](https://medium.com/r?url=https%3A%2F%2Fwww.typescriptlang.org%2Fdocs%2Fhandbook%2F2%2Fnarrowing.html%23discriminated-unions)
- [Demystifying TypeScript Discriminated Unions](https://medium.com/r?url=https%3A%2F%2Fcss-tricks.com%2Ftypescript-discriminated-unions%2F)
