...
**Bugs caught earlier are less expensive than bugs caught later in the process.** 
The best scenario is that you manage to catch bugs during development and while writing unit/integration tests. 
...
Shorten the feedback loop — do not use (long-living) feature branches.
